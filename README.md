...
箭头从 **21 支增加到 44 支**，单支长度从 1 格散开到 18 格。所有关卡都由程序校验过可解性。
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 第 1 关 | 初次拉弓 | 11×8 | 21 | 81 | 0.92 | 7 | ♥×4 | ★ | 300 |
| 第 2 关 | 交叉路口 | 13×9 | 23 | 113 | 0.97 | 6 | ♥×4 | ★ | 300 |
| 第 3 关 | 连锁反应 | 14×10 | 22 | 132 | 0.94 | 5 | ♥×5 | ★★ | 600 |
| 第 4 关 | 四面楚歌 | 16×11 | 27 | 166 | 0.94 | 5 | ♥×6 | ★★★ | 900 |
| 第 5 关 | 错位走廊 | 18×12 | 28 | 200 | 0.93 | 4 | ♥×6 | ★★★ | 900 |
| 第 6 关 | 纵横交错 | 20×14 | 33 | 266 | 0.95 | 4 | ♥×6 | ★★★★ | 1200 |
| 第 7 关 | 长蛇阵 | 22×15 | 38 | 316 | 0.96 | 3 | ♥×6 | ★★★★ | 1200 |
| 第 8 关 | 十面埋伏 | 23×17 | 43 | 367 | 0.94 | 3 | ♥×7 | ★★★★★ | 1500 |
| 第 9 关 | 万箭归一 | 26×18 | 44 | 441 | 0.94 | 2 | ♥×7 | ★★★★★ | 1500 |

> 满分合计 **8400**。九关全部由 `tools/generate_levels.py` 逆向构造生成，
> 再用 `tools/pick_levels.py` 从候选里挑出来（同一尺寸挑「铺满率最高 +
> 开局可点数最接近目标 + 箭头长短差距大」的那一版，单支长度 1~18 格不等）。
>
...
九个关卡的难度分是 23.2 / 32.8 / 37.0 / 49.3 / 58.7 / 74.4 / 91.4 / 106.7 / 120.6，
...
| `AnimationTestCase` | 整条箭头飞出、撞击抖动、飘字与心碎的生命周期 |
| `BackgroundTestCase` | 背景确实在动、暗角与光晕不越界 |
| `GameFlowTestCase` | 完整流程、场景渲染、总览交互、教学引导、9 关顺序通关、计时 / 提示 / 辅助线 / 缩放平移、界面三块分区不重叠、辅助线几何（`guide_segment` 与被挡路径共线且落在挡路那一格内、箭头飞走后消失） |
