...
------------------------------------------------------------------------------
   [OK] 可解，共 21 步
   参考顺序：(0,7)上 -> (10,0)下 -> (10,1)下 -> (3,7)右 -> (0,5)上 -> (1,5)右 -> (8,1)左 -> (3,4)右 -> (7,1)下 -> (3,3)右 -> (6,5)左 -> (7,2)左 -> (3,1)下 -> (3,0)右 -> (7,4)上 -> (4,6)上 -> (1,3)下 -> (8,7)上 -> (7,5)左 -> (4,0)右 -> (2,0)下

第  2 关  交叉路口   棋盘 13×9   箭头 23 支   密度 0.91   开局可点 7 支
         难度 ★   生命值 3 颗   本关满分 300 分
------------------------------------------------------------------------------
    0 | oo>voooo^
    1 | oov.oo.o>
...
------------------------------------------------------------------------------
   [OK] 可解，共 23 步
   参考顺序：(12,0)左 -> (2,8)右 -> (1,8)右 -> (8,0)左 -> (12,5)下 -> (7,0)左 -> (0,8)上 -> (2,6)右 -> (9,3)左 -> (7,1)下 -> (4,7)上 -> (3,8)上 -> (5,0)下 -> (9,5)左 -> (3,4)右 -> (5,8)上 -> (4,4)右 -> (9,8)上 -> (9,7)上 -> (12,3)左 -> (1,2)下 -> (0,3)下 -> (0,2)右

第  3 关  连锁反应   棋盘 14×10   箭头 22 支   密度 0.91   开局可点 6 支
         难度 ★   生命值 3 颗   本关满分 300 分
------------------------------------------------------------------------------
    0 | <oo<o<oovv
    1 | ..ooo<oo<o
...
------------------------------------------------------------------------------
   [OK] 可解，共 22 步
   参考顺序：(13,9)右 -> (13,3)下 -> (0,0)左 -> (2,1)左 -> (12,9)右 -> (11,9)右 -> (8,8)下 -> (5,2)上 -> (0,3)左 -> (0,5)左 -> (1,5)左 -> (6,4)上 -> (1,8)左 -> (2,8)左 -> (9,2)上 -> (0,9)下 -> (0,8)下 -> (13,7)上 -> (11,2)右 -> (12,5)上 -> (10,0)上 -> (13,6)右

第  4 关  四面楚歌   棋盘 16×11   箭头 27 支   密度 0.93   开局可点 4 支
         难度 ★★★   生命值 3 颗   本关满分 900 分
------------------------------------------------------------------------------
    0 | ooooooo<ooo
    1 | ovooooooooo
    2 | ooooovoooo>
...
------------------------------------------------------------------------------
   [OK] 可解，共 27 步
   参考顺序：(3,10)右 -> (14,1)左 -> (4,10)右 -> (2,10)右 -> (4,7)右 -> (14,3)左 -> (13,1)下 -> (15,6)左 -> (10,2)下 -> (13,4)左 -> (15,8)左 -> (13,6)左 -> (15,10)左 -> (13,9)左 -> (5,5)右 -> (5,4)右 -> (4,5)下 -> (9,0)右 -> (4,4)下 -> (2,5)下 -> (4,3)右 -> (4,1)下 -> (3,3)下 -> (1,1)下 -> (4,0)右 -> (3,0)下 -> (0,7)左

第  5 关  错位走廊   棋盘 18×12   箭头 28 支   密度 0.92   开局可点 5 支
...
------------------------------------------------------------------------------
   [OK] 可解，共 28 步
   参考顺序：(0,10)上 -> (3,0)左 -> (17,8)下 -> (5,0)左 -> (17,11)下 -> (3,3)左 -> (15,9)右 -> (7,2)左 -> (14,7)右 -> (6,2)左 -> (17,10)右 -> (3,5)左 -> (17,5)右 -> (6,4)左 -> (13,7)下 -> (17,3)右 -> (9,10)下 -> (16,3)右 -> (7,8)下 -> (15,3)右 -> (5,4)下 -> (17,0)右 -> (3,9)左 -> (15,1)右 -> (2,0)下 -> (1,1)下 -> (5,11)下 -> (0,5)左

第  6 关  纵横交错   棋盘 20×14   箭头 37 支   密度 0.93   开局可点 3 支
...
------------------------------------------------------------------------------
   [OK] 可解，共 37 步
   参考顺序：(19,3)下 -> (0,13)上 -> (19,0)下 -> (0,12)右 -> (19,4)左 -> (1,12)右 -> (17,2)左 -> (3,13)上 -> (14,0)下 -> (15,1)下 -> (2,12)右 -> (19,6)左 -> (11,1)下 -> (11,2)下 -> (18,6)左 -> (4,8)右 -> (5,13)上 -> (14,4)左 -> (13,4)左 -> (16,9)左 -> (5,3)下 -> (9,5)下 -> (6,13)上 -> (0,7)下 -> (1,6)右 -> (16,13)左 -> (3,3)右 -> (8,13)上 -> (5,0)下 -> (19,9)上 -> (10,13)上 -> (8,2)右 -> (9,2)右 -> (2,0)下 -> (15,13)左 -> (17,13)上 -> (19,13)上

第  7 关  长蛇阵   棋盘 22×15   箭头 35 支   密度 0.95   开局可点 5 支
         难度 ★★★★   生命值 4 颗   本关满分 1200 分
------------------------------------------------------------------------------
    0 | ooooooooooooo>^
    1 | oooo>o>o>oo>o.o
...
------------------------------------------------------------------------------
   [OK] 可解，共 35 步
   参考顺序：(18,0)左 -> (0,14)上 -> (21,0)下 -> (16,0)左 -> (17,0)左 -> (15,0)下 -> (18,3)左 -> (17,3)左 -> (0,13)右 -> (3,12)右 -> (16,1)左 -> (18,7)左 -> (12,0)下 -> (17,7)左 -> (7,13)上 -> (1,11)右 -> (16,3)左 -> (5,12)上 -> (8,0)下 -> (17,11)左 -> (10,13)上 -> (1,8)右 -> (16,8)左 -> (5,9)右 -> (7,12)上 -> (4,0)下 -> (16,14)上 -> (1,6)右 -> (3,5)右 -> (4,6)右 -> (3,0)下 -> (18,14)上 -> (1,4)右 -> (20,14)上 -> (20,13)上

第  8 关  十面埋伏   棋盘 23×17   箭头 43 支   密度 0.92   开局可点 6 支
         难度 ★★★★   生命值 4 颗   本关满分 1200 分
------------------------------------------------------------------------------
    0 | o........^.<o..ov
    1 | o.oooooooo^.o.ooo
...
------------------------------------------------------------------------------
   [OK] 可解，共 43 步
   参考顺序：(21,0)左 -> (11,16)右 -> (12,16)右 -> (1,10)上 -> (0,9)上 -> (6,16)右 -> (3,10)上 -> (12,14)右 -> (2,3)上 -> (5,10)上 -> (9,14)右 -> (8,12)右 -> (7,11)右 -> (10,10)上 -> (13,10)上 -> (10,9)右 -> (7,7)上 -> (12,7)右 -> (7,5)右 -> (13,7)上 -> (16,10)上 -> (13,6)右 -> (15,8)上 -> (18,10)上 -> (14,6)上 -> (6,3)右 -> (17,7)右 -> (18,8)上 -> (18,9)上 -> (16,6)右 -> (18,7)上 -> (16,4)右 -> (15,4)右 -> (21,7)右 -> (9,1)右 -> (15,0)上 -> (0,11)左 -> (3,12)左 -> (5,16)左 -> (19,0)上 -> (21,3)上 -> (3,14)左 -> (0,16)下
...
------------------------------------------------------------------------------
    ...
    4 | .o<ooooooooooooooo
    5 | ^o^.<o<o<ooooooooo
    6 | oooo.ooooooooooooo
    7 | .oooo.ooo<oooooooo
    8 | .oooooooo<ooo<ooov
    9 | <o^ooooooooooooooo
   10 | ^^oooooooooooooooo
   11 | oooooooooooooooooo
   12 | o^ooooooooooooo.oo
   13 | oooooooooo.oo.o.oo
   14 | ooooo..ooo.oo.o.oo
   15 | >^..o...oo.oo.oooo
   16 | >ooooooooo.ooooovo
   17 | ^^oooooooo.oooo.vo
   18 | ooooooooo...oooooo
   19 | ooooooooo....ooovo
   20 | ^ooooooooooooooooo
   21 | oooooooooooooooovo
   22 | ^^oo.oooo>o>oooooo
   23 | ooooooooo>o>o>o..o
   24 | ooooooooooooooo>oo
   25 | oooooooooooooooov>
------------------------------------------------------------------------------
   [OK] 可解，共 46 步
   参考顺序：(25,16)下 -> (0,0)左 -> (25,17)右 -> (1,0)左 -> (3,0)左 -> (9,0)左 -> (1,4)左 -> (21,16)下 -> (24,15)右 -> (5,0)上 -> (4,2)左 -> (10,0)上 -> (2,8)左 -> (19,16)下 -> (10,1)上 -> (23,13)右 -> (5,2)上 -> (3,10)左 -> (12,1)上 -> (23,11)右 -> (17,16)下 -> (22,11)右 -> (9,2)上 -> (5,4)左 -> (23,9)右 -> (16,16)下 -> (15,1)上 -> (22,9)右 -> (5,6)左 -> (17,1)上 -> (5,8)左 -> (7,9)左 -> (8,9)左 -> (8,13)左 -> (16,0)右 -> (8,17)下 -> (15,0)右 -> (17,0)上 -> (1,11)左 -> (20,0)上 -> (1,14)左 -> (22,0)上 -> (3,17)下 -> (22,1)上 -> (2,16)下 -> (0,17)下

校验结果：教学关 + 全部 9 个编号关卡均可正常通关。
难度参考：棋盘逐关放大，最大的一关是第 9 关 26×18（468 格）；
          箭头逐关变多（21 → 46 支），开局可点的反而从 5 支收到 6 支。
...
| 1 | 初次拉弓 | 11×8 | 21 | 81 | 0.92 | 5 | ♥×3 | ★ | 300 |
| 2 | 交叉路口 | 13×9 | 23 | 107 | 0.91 | 7 | ♥×3 | ★ | 300 |
| 3 | 连锁反应 | 14×10 | 22 | 128 | 0.91 | 6 | ♥×3 | ★ | 300 |
| 4 | 四面楚歌 | 16×11 | 27 | 163 | 0.93 | 4 | ♥×3 | ★★ | 600 |
| 5 | 错位走廊 | 18×12 | 28 | 199 | 0.92 | 5 | ♥×4 | ★★★ | 900 |
| 6 | 纵横交错 | 20×14 | 37 | 259 | 0.93 | 3 | ♥×4 | ★★★★ | 1200 |
| 7 | 长蛇阵 | 22×15 | 38 | 304 | 0.92 | 4 | ♥×4 | ★★★★ | 1200 |
| 8 | 十面埋伏 | 23×17 | 43 | 360 | 0.92 | 6 | ♥×4 | ★★★★ | 1200 |
| 9 | 万箭归一 | 26×18 | 46 | 432 | 0.92 | 6 | ♥×4 | ★★★★★ | 1500 |

9 个编号关卡合计 **285 支箭头**（单支 1~18 格）、满分合计 **7500 分**。
九个编号关卡全部由 `tools/generate_levels.py` **逆向构造**生成（从构造方式上就保证可解），
再由 `tools/pick_levels.py` 从同一尺寸的候选里挑出「开局可点数达标 + 朝向最均衡
（最大单朝向占比 26%~45%，四个方向都看得到）+ 铺满率高 +
箭头长短差（标准差）大」的那一版，
...
棋盘越大、箭头越长（平均单支从 3.9 格一路涨到 9.4 格），越难一眼找出能点的那支。
开局可点数第 1 关 5 支起步、第 6 关收到 3 支，后期为画面朝向均衡放宽到 4~6 支，
由更紧的生命值（3/4 颗）补回来——它依然是真正决定手感的那一项。
